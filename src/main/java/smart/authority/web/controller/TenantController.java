...
public class TenantController {
    ...
    public ApiResponse<Tenant> getTenant(@PathVariable Integer id) {
    ...
    public ApiResponse deleteTenant(@PathVariable Integer id) {
    ...
    public ApiResponse<Tenant> updateTenant(@PathVariable Integer id, @RequestBody Tenant tenant) {
        tenant.setId(id);
